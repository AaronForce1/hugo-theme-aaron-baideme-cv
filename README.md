# Aaron Vincent Baideme CV Theme
...
To use `hugo-theme-aaron-baideme-cv` theme you need to install Hugo Extended by following https://gohugo.io/getting-started/installing/.
...
git init
git submodule add https://github.com/aaronforce1/hugo-theme-aaron-baideme-cv.git themes/aaron-baideme-cv
```
Replace the files in your site root's directory with the ones in `themes/aaron-baideme-cv/example`.
